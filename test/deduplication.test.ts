...
import type { LoadedLifeEvent } from "../src/types.js";

function mockLoadedEvent(id: string, title: string, react?: { feeling?: string; thought?: string; action?: string; updated_at?: string }): LoadedLifeEvent {
	return {
		event: {
			id,
